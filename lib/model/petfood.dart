class Petfood {
  ...
  //getter setter untuk nama petfood
  String get nama => this._nama;
  set nama(String value) => this._nama = value;

  //getter setter untuk gambar petfood
  String get gambar => this._gambar;
  set gambar(String value) => this._gambar = value;

  //getter setter untuk detail petfood
  String get detail => this._detail;
  set detail(String value) => this._detail = value;

  //getter setter untuk price petfood
  get price => this._price;
  set price(value) => this._price = value;

  //getter setter untuk stok petfood
  get stok => this._stok;
  set stok(value) => this._stok = value;

  Petfood(this._nama, this._gambar, this._detail, this._price, this._stok);

  //konversi dari Map ke pet
  Petfood.fromMap(Map<String, dynamic> map) {
    this._id = map['id'];
    this._nama = map['nama'];
